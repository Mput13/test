...
class AssociationTable(SqlAlchemyBase, SerializerMixin):
    __tablename__ = 'association'

    id = sqlalchemy.Column(sqlalchemy.Integer, primary_key=True, autoincrement=True)
    jobs = sqlalchemy.Column('jobs', sqlalchemy.Integer, sqlalchemy.ForeignKey('jobs.id'))
    category = sqlalchemy.Column(
        'category', sqlalchemy.Integer,
